...
map.getView().fit([14935322.816843, 4233892.174070, 14935434.724147, 4233998.013865], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        var teamMAttribution = document.createElement('li');
        teamMAttribution.innerHTML = '<a href="http://muses.muses.tottori-u.ac.jp/faculty/morimoto/">TeamM</a> &middot; ';
        ...
        attributionList.insertBefore(teamMAttribution, firstLayerAttribution);

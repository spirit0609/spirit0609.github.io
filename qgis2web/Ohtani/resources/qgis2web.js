...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [14949942.986857, 4241284.217536, 14950526.873047, 4241704.167443], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([14949942.986857, 4241284.217536, 14950526.873047, 4241704.167443], map.getSize());
